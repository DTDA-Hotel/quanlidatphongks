...
<form action="<?php echo e(route("admin.updroom",["id"=>$roomdata->id])); ?>" method="POST" class="form" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
    ...
    <textarea class="form-control" id="amenities" name="amenities"><?php echo e(old("amenities",$roomdata->amenities)); ?></textarea>
    <label class="form-label" for="position">Vị trí</label>
    <input id="position" class="form-control" type="text" name="position" value="<?php echo e(old("position",$roomdata->position)); ?>">
...
<?php echo $__env->make("admin.layout.main", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Documents\quanlidatphongks\resources\views/admin/Room/edit.blade.php ENDPATH**/ ?>