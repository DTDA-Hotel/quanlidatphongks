            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-5 offset-xl-2 offset-lg-1">
                    <div class="booking-form">
                        <h3><?php echo e(__('messages.booknow')); ?></h3>
                        <form action="<?php echo e(route('search.pending')); ?>" method="GET">
                            <div class="check-date">
                                <label for="date-in"><?php echo e(__('messages.cin')); ?>:</label>
                                <input type="text" class="date-input" id="date-in" name="date_in">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="check-date">
                                <label for="date-out"><?php echo e(__('messages.cout')); ?>:</label>
                                <input type="text" class="date-input" id="date-out" name="date_out">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="select-option">
                                <label for="guest"><?php echo e(__('messages.guest')); ?>:</label>
                            ...
                            <div class="select-option">
                                <label for="room"><?php echo e(__('messages.rn')); ?>:</label>
                            ...
                            <button type="submit"><?php echo e(__('messages.checkavai')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <section class="hp-room-section">
        <div class="container-fluid">
            <div class="hp-room-items">
                <div class="row">
                    <?php $__currentLoopData = $room; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg"
                                data-setbg="<?php echo e(asset(url('')) . "/storage/upload/$k->pimage"); ?>">
                                <div class="hr-text">
                                    <h3 class="text-readable"><?php echo e($k->name); ?></h3>
                                    ...
                                    <a style="  text-decoration: underline;" class="text-readable"
                                        href="<?php echo e(route('client.roomdetail', ['id' => $k->id])); ?>"
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Videos\Captures\quanlidatphongks\resources\views/client/index.blade.php ENDPATH**/ ?>