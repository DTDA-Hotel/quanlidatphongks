...
<body>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li >
                <a id="cate" href="<?php echo e(route("admin.category")); ?>" > Danh mục </a>
                <!-- class="active" -->
              </li>
              <li >
                <a id="rooms" href="<?php echo e(route("admin.roomlist")); ?>">Các phòng</a>
              </li>
              <li >
                <a id="acc" href="<?php echo e(route("admin.account")); ?>"> Tài khoản </a>
              </li>
              <li >
                <a id="imgst" href="<?php echo e(route("storage.image")); ?>"> Kho ảnh </a>
              </li>
              <li >
              ...
              <li><a href="<?php echo e(route("admin.bills.index")); ?>" id="bill">Hóa đơn</a></li>
              <li><a href="<?php echo e(route("admin.hotel")); ?>" id="hotel">Khách sạn</a></li>
            </ul>
          </li>
        </ul>
      </nav>
  ...
  <script src="<?php echo e(asset(url(""))); ?>/admin/js/main.js"></script>
    ...
    <script>
      ...
      let jso = <?php echo json_encode(session("check"), 15, 512) ?>;
      // console.log(jso);
...
</html><?php /**PATH C:\Users\Admin\Videos\Captures\quanlidatphongks\resources\views/admin/layout/main.blade.php ENDPATH**/ ?>