          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li class="d-flex justify-content-center">
                <a class="" href="<?php echo e(route("admin.category")); ?>" id="cate"> Danh mục </a>
                <!-- class="active" -->
              </li>
              <li class="d-flex justify-content-center">
                <a href="<?php echo e(route("admin.roomlist")); ?>" id="rooms">Các phòng</a>
              </li>
              <li class="d-flex justify-content-center"><a id="imgst" href="<?php echo e(route("storage.image")); ?>">Kho ảnh</a></li>
              <li class="d-flex justify-content-center"><a id="trash" href="<?php echo e(route("storage.trashedimg")); ?>">Thùng rác</a></li>
              <li class="d-flex justify-content-center"><a id="acc" href="<?php echo e(route("admin.account")); ?>">Tài khoản</a></li>
...
<?php echo $__env->yieldContent("main"); ?>
    ...
    <script>
            let dataList = <?php echo json_encode(session("check"), 15, 512) ?>;
...
<?php /**PATH E:\Documents\PHP\quanlidatphongks\resources\views/admin/layout/main.blade.php ENDPATH**/ ?>